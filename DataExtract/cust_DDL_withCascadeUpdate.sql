...
) ENGINE=InnoDB AUTO_INCREMENT=68599 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_AuditAdminData` (
  ...
  KEY `idx_CustomerID_CreateDate` (`CustomerID`,`CreateDate`),
  KEY `idx_CustomerID_ObjectType_ObjectID` (`CustomerID`,`ObjectType`,`ObjectID`)
) ENGINE=InnoDB AUTO_INCREMENT=129353 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_AuditExport` (
  ...
  `MatterNumber` varchar(150) NOT NULL DEFAULT '',
...
) ENGINE=InnoDB AUTO_INCREMENT=992888 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=4159416 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1022448 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=25630361 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=8553 DEFAULT CHARSET=utf8;
CREATE TABLE `tbl_Budget` (
  `BudgetID` varchar(255) NOT NULL DEFAULT '',
  `CustomerID` int(11) NOT NULL,
  `TotalAmount` decimal(11,2) DEFAULT NULL,
  `EncumberedAmount` decimal(11,2) NOT NULL DEFAULT '0.00',
  `LiquidatedAmount` decimal(11,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`BudgetID`,`CustomerID`),
  KEY `FK_Budget_Customer` (`CustomerID`),
  CONSTRAINT `FK_Budget_Customer` FOREIGN KEY (`CustomerID`) REFERENCES `tbl_Customer` (`CustomerID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=7766621 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_BusinessRulesTmp` (
  ...
  `PkgData` longblob,
  PRIMARY KEY (`EntryID`)
) ENGINE=InnoDB AUTO_INCREMENT=109756 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=103326 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=188083 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=84175 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=419001 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=307 DEFAULT CHARSET=utf8 COMMENT='American Express customer configuration information';
...
CREATE TABLE `tbl_CustomerData` (
  ...
  `InvoiceRulesDefaultPersonID` int(11) NOT NULL DEFAULT '-1',
  `PORulesDefaultPersonID` int(11) NOT NULL DEFAULT '-1',
  `ExpenseReportAuditRulesDefaultPersonID` int(11) NOT NULL DEFAULT '-1',
  PRIMARY KEY (`CustomerID`),
...
) ENGINE=InnoDB AUTO_INCREMENT=12731065 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10717665 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_CustomerSubscription` (
  `CustomerSubscriptionID` char(36) NOT NULL,
  `CustomerID` int(11) NOT NULL,
  ...
  KEY `FK_tbl_CustomerSubscription_Customer` (`CustomerID`),
  CONSTRAINT `FK_tbl_CustomerSubscription_Customer` FOREIGN KEY (`CustomerID`) REFERENCES `tbl_Customer` (`CustomerID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=24779 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=320837406 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_DataLock_InvoiceHeader` (
  ...
  `DataLockType` char(4) NOT NULL,
  `ProcessType` char(4) DEFAULT NULL COMMENT 'Process that triggered the lock',
  `PersonID` int(11) DEFAULT NULL,
  `CreateDate` datetime DEFAULT NULL,
  PRIMARY KEY (`DataLockID`),
...
) ENGINE=InnoDB AUTO_INCREMENT=94527245 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1254875 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=180867 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=15089 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=18775 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=64371 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=45994583 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=46225592 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=11842457 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=23718609 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=374274 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=769544 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=37071580 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2065626 DEFAULT CHARSET=utf8 COMMENT='Track frequent locations related to Expenses.';
...
) ENGINE=InnoDB AUTO_INCREMENT=1115657 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=490682 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=81313174 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=307799630 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=4348327 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1508661 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=415507751 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=28084012 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_ExpenseReportReceiptCheckIn` (
  `ExpenseReportReceiptCheckInID` char(36) NOT NULL,
  `ExpenseReportHeaderID` char(36) NOT NULL,
  `CustomerID` int(11) NOT NULL,
  `PersonID` int(11) NOT NULL,
  `CheckInStatus` char(15) DEFAULT NULL,
  `CreateDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `UpdateDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`ExpenseReportReceiptCheckInID`),
  KEY `FK_tbl_ExpenseReportReceiptCheckIn_ExpenseReportHeader` (`ExpenseReportHeaderID`),
  CONSTRAINT `FK_tbl_ExpenseReportReceiptCheckIn_ExpenseReportHeader` FOREIGN KEY (`ExpenseReportHeaderID`) REFERENCES `tbl_ExpenseReportHeader` (`ExpenseReportHeaderID`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_ExpenseTransaction` (
  ...
  CONSTRAINT `tbl_ExpenseTransaction_ibfk_4` FOREIGN KEY (`ParentID`) REFERENCES `tbl_ExpenseTransaction` (`ExpenseTransactionID`),
...
) ENGINE=InnoDB AUTO_INCREMENT=52923049 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=145477 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=26170 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=465740 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=3875362 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=610677 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=14000503 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_Feed` (
  ...
  PRIMARY KEY (`FeedID`),
  UNIQUE KEY `FK_tbl_Feed_2` (`IntegrationID`),
...
CREATE TABLE `tbl_FinalLiquidationExport` (
  ...
  PRIMARY KEY (`FinalLiquidationExportID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_FinalLiquidationExportData` (
  ...
  CONSTRAINT `FK_FLExportData_PAHeader` FOREIGN KEY (`PAHeaderID`) REFERENCES `tbl_PAHeader` (`PAHeaderID`) ON UPDATE CASCADE,
  CONSTRAINT `FK_FinalLiquidationExportData_FinalLiquidationExport` FOREIGN KEY (`FinalLiquidationExportID`) REFERENCES `tbl_FinalLiquidationExport` (`FinalLiquidationExportID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=9436967 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=129859 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=5925655 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=269924576 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=411633859 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=12678775 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=4350177 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=36058231 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2544234 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10849 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=12776645 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=225784 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=54966171 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=9241252 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=145834 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=383785 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=561193 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1286944 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=57134347 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=39430728 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=26080771 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=65747702 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1410548 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=45779464 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=557385 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=225270 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_Person` (
  ...
  CONSTRAINT `FK_Person_6` FOREIGN KEY (`ReportsToPersonID`) REFERENCES `tbl_Person` (`PersonID`),
  CONSTRAINT `FK_tbl_Person_7` FOREIGN KEY (`Country_Alpha2`) REFERENCES `tbl_Country` (`Alpha2`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3288479 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_Person_Entity_v2` (
  ...
  KEY `idx_UpdateDate` (`UpdateDate`)
) ENGINE=InnoDB AUTO_INCREMENT=15213828 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_Person_Person` (
  ...
  CONSTRAINT `FK_tbl_Person_Person_1` FOREIGN KEY (`FromPersonID`, `CustomerID`) REFERENCES `tbl_Person` (`PersonID`, `CustomerID`),
  CONSTRAINT `FK_tbl_Person_Person_2` FOREIGN KEY (`ToPersonID`, `CustomerID`) REFERENCES `tbl_Person` (`PersonID`, `CustomerID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2534714 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=98222 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=79685 DEFAULT CHARSET=utf8 COMMENT='Information about credit cards for Direct Pay';
...
CREATE TABLE `tbl_PersonDirectPayCreditCard` (
  ...
  `AccountNumberEncrypted` varchar(130) NOT NULL,
  `ManagedKeyID` char(36) NOT NULL,
  `AccountIdentifier` varchar(15) DEFAULT NULL COMMENT 'AccountIdentifier from the CDF3 transaction file',
  `Status` char(4) NOT NULL,
  `CreateDate` datetime NOT NULL,
  `UpdateDate` datetime DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=236531 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=534913 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_PoReqAuditData` (
  ...
  KEY `PersonLoggedIn` (`PersonLoggedInId`),
  KEY `PersonDelegate` (`PersonDelegateId`)
) ENGINE=InnoDB AUTO_INCREMENT=718415 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=31287 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=98227 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=337179 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=51607 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=44316 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=372457 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=3707542 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=194820086 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=4669880 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=123368 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=29277058 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=44772500 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=21403802 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1549585 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=704057 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2582144 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=46377188 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=6636561 DEFAULT CHARSET=utf8 COMMENT='State information about a barcoded receipt file';
...
) ENGINE=InnoDB AUTO_INCREMENT=5159166 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=620194 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=141182 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=590569 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1851185 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=22762 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=243087 DEFAULT CHARSET=utf8 COMMENT='Temporary locking table for invoice rule groups';
...
) ENGINE=InnoDB AUTO_INCREMENT=205523 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_TransactionProcessingStatus` (
  `TransactionProcessingStatusID` int(11) NOT NULL AUTO_INCREMENT,
  `CustomerID` int(11) NOT NULL,
  `ExpenseTransactionID` int(11) NOT NULL,
  `FeedID` int(11) NOT NULL,
  `Status` varchar(20) NOT NULL,
  `CreateDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`TransactionProcessingStatusID`),
  KEY `FK_TransactionProcessingStatus_ExpenseTransaction` (`CustomerID`,`ExpenseTransactionID`),
  KEY `FK_TransactionProcessingStatus_Feed` (`CustomerID`,`FeedID`),
  CONSTRAINT `FK_TransactionProcessingStatus_ExpenseTransaction` FOREIGN KEY (`CustomerID`, `ExpenseTransactionID`) REFERENCES `tbl_ExpenseTransaction` (`CustomerID`, `ExpenseTransactionID`) ON UPDATE CASCADE,
  CONSTRAINT `FK_TransactionProcessingStatus_Feed` FOREIGN KEY (`CustomerID`, `FeedID`) REFERENCES `tbl_Feed` (`CustomerID`, `FeedID`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_TravelTransaction` (
  ...
  `ItineraryReference` varchar(255) DEFAULT NULL COMMENT 'Itinerary Reference from 3rd party',
...
) ENGINE=InnoDB AUTO_INCREMENT=892603 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=689269 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=408735 DEFAULT CHARSET=utf8;
